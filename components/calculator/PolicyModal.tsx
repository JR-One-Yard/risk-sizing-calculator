    ...
    <Modal isOpen={isOpen} onClose={handleCancel} title="Risk Policy Settings" size="xl">
      ...
      <div className="space-y-6 min-h-[400px]">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-brand-tint border border-border rounded-[10px] p-4">
              <div className="flex items-center justify-between mb-4">
                <div>
                  <h4 className="font-semibold text-ink">Type I - High Conviction</h4>
                  <p className="text-sm text-ink-muted">Highest confidence trades</p>
                </div>
            ...
            <div className="bg-success-bg border border-success-border rounded-[10px] p-4">
              <div className="flex items-center justify-between mb-4">
                <div>
                  <h4 className="font-semibold text-ink">Type II - Medium Conviction</h4>
                  <p className="text-sm text-ink-muted">Standard confidence trades</p>
                </div>
            ...
            <div className="bg-warning-bg border border-warning-border rounded-[10px] p-4">
              <div className="flex items-center justify-between mb-4">
                <div>
                  <h4 className="font-semibold text-ink">Type III - Low Conviction</h4>
                  <p className="text-sm text-ink-muted">Lower confidence or experimental trades</p>
                </div>
        ...
        {activeTab === 'caps' && (
          <div className="space-y-6">
            <div>
              <h3 className="text-lg font-semibold text-ink mb-4">Global Risk Caps</h3>
              <p className="text-sm text-ink-muted mb-6">
                Hard limits that override conviction-based risk calculations.
              </p>
            </div>

            <div className="bg-error-bg border border-error-border rounded-[10px] p-4">
            ...
            <div className="bg-warning-bg border border-warning-border rounded-[10px] p-3">
              <div className="flex items-start">
                <svg
                  className="h-5 w-5 text-warning mt-0.5 mr-3"
                  fill="currentColor"
                  viewBox="0 0 20 20"
                >
                  <path
        ...
        {activeTab === 'volatility' && (
          <div className="space-y-6">
            <div>
              <div className="flex items-center justify-between mb-4">
                <div>
                  <h3 className="text-lg font-semibold text-ink">Volatility Settings</h3>
            ...
            <div className="bg-brand-tint border border-border rounded-[10px] p-4">
              <label className="flex items-center justify-between cursor-pointer">
                <div>
                  <div className="font-semibold text-ink">Enable Volatility Adjustment</div>
                ...
                <input
                  ...
                  className="w-5 h-5 text-brand rounded focus:ring-blue-500"
                />
              </label>
            </div>
            ...
            {formData.volatility.enabled && (
              <>
                ...
                <div>
                  <h4 className="font-semibold text-ink mb-4">Position Size Multipliers</h4>
                  ...
                  <div className="space-y-3">
                    {Object.entries(VOLATILITY_CONFIGS).map(([key, config]) => {
                      ...
                      return (
                        <div
                          key={key}
                          className="flex items-center justify-between p-3 border border-border rounded-[10px] bg-white"
                        >
                          <div className="flex-1">
                            <div className="font-semibold text-ink">
                              {config.class.replace('_', ' ')}
                            </div>
                            <div className="text-xs text-ink-muted">{config.annualizedRange}</div>
                          </div>
                          <Input
                            type="number"
                ...
                <div className="bg-brand-tint border border-border rounded-[10px] p-4">
                  <div className="space-y-4">
                    <label className="flex items-center justify-between cursor-pointer">
                      <div>
                        <div className="font-semibold text-ink">Enable ATR Analysis</div>
                        <p className="text-sm text-ink-muted">
        ...
        {activeTab === 'trade-mgmt' && (
          <div className="space-y-6">
            ...
            <div className="bg-brand-tint border border-border rounded-[10px] p-3">
              <div className="flex items-start">
                <svg
                  className="h-5 w-5 text-brand mt-0.5 mr-3"
                  fill="currentColor"
                  viewBox="0 0 20 20"
                >
                  <path
